  ...
  return (
    <LandingWrapper>
      <section className="relative py-14">
        <Container>
          <div className="relative w-full mx-auto bg-light dark:bg-dark shadow-md rounded-xl overflow-hidden transition-colors duration-300">
                    ...
                    <div className="relative col-span-2 max-md:col-span-2">
                      <div className="grid grid-cols-2 gap-4 border-t border-semi-dark py-5">
                        <div className="relative col-span-2 max-md:col-span-2">
                          ...
                          <p className="text-xs">
                            The percentage of the transaction that will be sent
                            to wallet set here. Maximum of 10%.
                          </p>
                        </div>
                        <div className="relative col-span-1 max-md:col-span-2">
                          <div className="relative">
                    ...
                    <div className="relative col-span-2 max-md:col-span-2">
                      <div className="grid grid-cols-2 gap-4 border-t border-semi-dark py-5">
                        <div className="relative col-span-2 max-md:col-span-2">
                          ...
                          <p className="text-xs">
                            The percentage of the transaction that will be added
                            to the liquidity pool. Maximum of 10%.
                          </p>
                        </div>
                        <div className="relative col-span-1 max-md:col-span-2">
                          <div className="relative">
